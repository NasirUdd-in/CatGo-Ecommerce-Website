...
const Header = () => {
  ...
  return (
    <Navbar
      ...
      expand="md"
      sticky="top"
      style={{ backgroundColor: "rgb(280, 251, 249)", borderBottom: "3px solid #ccc" }}
    >
            ...
            {user?.email || user?.displayName ? (
              <div className="loggedin d-flex d-lg-block justify-content-center flex-column text-center">
                ...
                <Link to="/dashboard" className="text-decoration-none">
                  <Button
                    className="btn-warning fw-bold text-white ms-md-4 px-4 py-2 shadow-none my-2"
                  >
                    DashBoard
                  </Button>
                </Link>
                <Link to="/login" className="text-decoration-none">
                  <Button
                    onClick={logOut}
                    className="btn-danger fw-bold text-white ms-md-4 px-4 py-2 shadow-none my-2"
                  >
                    LogOut
                  </Button>
                </Link>
              ...
              <Link to="/login" className="text-decoration-none ms-md-5">
                <Button className="btn-warning fw-bold text-white px-4 py-2 shadow-none">
                  LogIn
                </Button>
              </Link>
            )}
