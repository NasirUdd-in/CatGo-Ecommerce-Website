...
const Order = () => {
  ...
  useEffect(() => {
    fetch(`https://salty-dawn-56606.herokuapp.com/products/${productid}`)
      .then((res) => res.json())
  ...
  const onSubmit = (data) => {
    ...
    fetch("https://salty-dawn-56606.herokuapp.com/placeorder", {
      method: "POST",
      headers: {
          ...
          <div className="col-12 col-lg-6">
            <div className="order-details my-5 p-3 shadow-lg">
              ...
              <h5 className="text-cyan my-2 text-center">
                You've Ordered {orderedProduct?.title} For Your cat.
              </h5>
            ...
            <div className="form-container py-5">
              ...
              >
                ...
                <p className="text-cyan text-center mb-5">
                  Hi! You can canel order from My orders section within next 7 days.
