            ...
            >
              ...
              <Row>
                <div className="col-12 col-md-6 mx-auto">
                  ...
                  <Button
                    type="submit"
                    className="btn-warning p-3 fw-bold btn-block w-100 shadow-none"
                  >
                    Register
                  </Button>
                </div>
              ...
              <Row>
                <span className="text-white fw-semi-bold mt-5">
                  ...
                  <Link to="/login" className="fw-semi-bold text-warning">
                    {" "}
                    Login Now
                  </Link>
                </span>
                <Link to="/">
                  <Button className="btn-warning shadow-none p-3 fw-semi-bold mb-5 mt-3 text-white">
                    Go Back to Home
                  </Button>
                </Link>
              </Row>
