...
const Dashboard = () => {
  ...
  useEffect(() => {
    document.title = "CatGo | DashBoard";
  }, []);

  return (
    <div>
      <div>
        <div className="bg-warning mobilebar d-none">
          <div className="bg-warning d-flex justify-content-between align-items-center flex-bg px-3">
            <button
            ...
            >
              <i
                style={{ color: "red" }}
                className="fas fa-2x fa-angle-double-right text-white"
              ></i>
            </button>
            <div>
              <img
        ...
        <Offcanvas show={show} onHide={handleClose} className="w-75">
          ...
          <Offcanvas.Body >
            {!admin && (
              <>
                <div
                  ...
                  onClick={handleClose}
                >
                  <i className="fas fa-shopping-basket text-warning me-2"></i>
            ...
            {admin && (
              <>
                <div
                  ...
                  onClick={handleClose}
                >
                  <i className="fas fa-user text-warning text-warning me-2"></i>
                ...
                <div
                  ...
                  onClick={handleClose}
                >
                  <i className="fas fa-plus text-warning me-2"></i>
                ...
                <div
                  ...
                  onClick={handleClose}
                >
                  <i className="fas fa-cannabis text-warning me-2"></i>
            ...
            <div
              ...
              onClick={handleClose}
            >
              <i className="fas fa-user-tie text-warning me-2"></i>
              <NavLink to={`${url}`}>Profile</NavLink>
            </div>
            <div
              className="d-flex justify-content-start text-warning align-items-center mt-2"
              onClick={handleClose}
            >
              <i className="fas fa-home text-warning me-2"></i>
        ...
        <div>
          <div className="bg-warning logo-bg d-lg-flex justify-content-center single-cat">
            <img
              style={{ height: "80px" }}
