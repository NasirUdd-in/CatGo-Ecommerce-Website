      ...
      <section className="form-container py-5 my-5">
        <Container>
          <Row>
            ...
            >
              <h2 className="text-center display-3 abril-font mt-5 pt-5">
                Stay With Us To Know Latest Info!
              </h2>
              <p className="text-cyan px-md-5 text-center mb-5">
                The  fiber concentrate for pet food. Improves gut health
          ...
          <Row>
            ...
            >
              <img
                src="https://i.ibb.co/kMZG9MP/photo-1493101561740-e745892775b2.jpg"
                alt="contactImg"
                className="border border-warning rounded img-fluid w-100"
              />
            </div>
            <div
              className="col-12 col-md-6"
              ...
              <Form>
                ...
                <Row>
                  ...
                  <Button
                    ...
                    type="submit"
                    className="btn-warning p-3 fw-bold shadow-none"
                  >
                    Ask Anything
                  </Button>
                </Row>
